...
TitleId = "16A212"
SecretKey = "XR8T5YJ19QNYXEMUBR1HZ5TAZM1UQ5EKGP1IDFY1TMO1JZ9H9I"
ApiKey = "OC|23929628313334088|51466719b0e7c3fd0118876be619e40e"
DiscordWebhook = "https://discord.com/api/webhooks/1380788004104310784/Vsy0wrr3u8Qx4fdmvJ8AKxzRRXplvUH9g00hXCDt3z2qraLISwtg56fAK7nxvvqObwc1"
...
def link_custom_id(playfab_id, session_ticket, entity_token, entity_id, entity_type, TitleId, CustomId, SecretKey):
    link_response = requests.post(
        url=f"https://{TitleId}.playfabapi.com/Server/LinkServerCustomId",
        json={
            "ForceLink": True,
